...
CREATE INDEX IF NOT EXISTS idx_vessel_subscriptions_paddle ON public.vessel_subscriptions(paddle_subscription_id) WHERE paddle_subscription_id IS NOT NULL;
